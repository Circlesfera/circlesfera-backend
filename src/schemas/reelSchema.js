...
export const createStitchSchema = z.object({
  ...
  allowDuets: z.boolean().optional().default(true),
  allowStitches: z.boolean().optional().default(true),
  stitchStartTime: z.coerce.number().min(0, 'El tiempo de inicio debe ser positivo').optional().default(0),
  stitchDuration: z.coerce.number().min(1, 'La duración debe ser al menos 1 segundo').max(15, 'La duración no puede exceder 15 segundos').optional().default(5)
})
